  ...
  describe('Prompt Injection via Tool Args', () => {
    it('handles prompt injection attempts in command arguments safely', async () => {
      ...
      for (const injection of injections) {
        ...
        // The output should contain our controlled response, wrapped with DATA markers
        // for prompt-injection hardening (not something generated by following injection instructions)
        expect(result.output).toContain('executed_safely')
